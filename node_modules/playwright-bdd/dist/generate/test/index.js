...
const arity_checker_1 = require("./arity-checker");
// todo: class StepGen ?
/**
...
class TestGen {
    ...
    ownTestTags) {
        ...
        this.arityChecker = new arity_checker_1.ArityChecker(this.featureUri, this.config);
    ...
    fillStepHooksFixtureNames() {
        const beforeStepHooksToRun = (0, step_1.getStepHooksToRun)('beforeStep', this.tags);
        const afterStepHooksToRun = (0, step_1.getStepHooksToRun)('afterStep', this.tags);
        this.stepHooksFixtureNames = (0, step_1.getStepHooksFixtureNames)([
